...
public class GCCollectorAfterProcess implements Plugin {
    ...
    public void onFinish() {
        ...
        int numberOfNodes = csCallGraph.getNumberOfMethods();
        int numberOfEdges = csCallGraph.getNumberOfEdges();
        logger.info("Call graph statistics: {} nodes (methods), {} edges", numberOfNodes, numberOfEdges);
        pw.println("Call graph statistics: " + numberOfNodes + " nodes (methods), " + numberOfEdges + " edges");
